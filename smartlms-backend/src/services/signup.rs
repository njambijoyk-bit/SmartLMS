...
pub mod service {
    ...
    pub async fn signup(
        ...
        let onboarding = onboarding::init_onboarding(
            pool,
            institution.id,
            plan_tier == Some(crate::models::institution::PlanTier::Starter),
        )
        .await
        .ok();
    ...
    pub async fn request_domain_verification(
        ...
        Ok(DomainVerificationInfo {
            ...
            instructions: "Add a TXT record to your DNS configuration with the value shown above."
                .to_string(),
