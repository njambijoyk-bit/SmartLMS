...
pub mod ai_analysis {
    ...
    pub async fn analyze_session(
        ...
        let face_present_pct = if total_frames > 0.0 { face_present / total_frames } else { 0.0 };
        ...
        if multiple_faces > 0 {
            recommendations.push("Multiple faces detected - possible assistance from another person".to_string());
        }
